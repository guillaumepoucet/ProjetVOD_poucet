...
<body>
    ...
    <section class="admin">
        ...
        <div class="tabs">
            <div class="tablink" onclick="openPage('filmAdd', this, '#FF7200')" id="defaultOpen">Mon profil</div>
            <div class="tablink" onclick="openPage('filmAdd', this, '#FF7200')" id="defaultOpen">Modifier mes infos</div>
        </div>
