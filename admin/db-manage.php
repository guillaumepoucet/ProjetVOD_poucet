<div id="admin-film">
    ...
    <div class="sub-menu">
        ...
        <button class="subtablinks" onclick="openSubTab('actorEdit', this)">Ajouter un acteur à un film</button>
        ...
        <h5>Gérer les genres</h5>
        <button class="subtablinks" onclick="openSubTab('typeManage', this)">Ajouter un genre</button>
        <button class="subtablinks" onclick="openSubTab('typeManage', this)">Ajouter un genre à un film</button>
    </div>

    <?php include 'include/db-manage-film.php' ?>
    <?php include 'include/db-manage-actor.php' ?>
    <?php include 'include/db-manage-type.php' ?>
